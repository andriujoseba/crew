...
- installing converges the engine tree to what the version ships: a file the incoming tree does not carry is moved to `~/duty/legacy/`, named on the way, rather than left behind and recorded as shipped (#159)

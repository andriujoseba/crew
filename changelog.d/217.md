...
- Teardown tells "found nothing" from "could not look": a class it cannot
  inspect — no gh identity, no box CLI, an unreadable `box list` — exits 2
  INCOMPLETE, naming the class, instead of reporting a clean host (#217).

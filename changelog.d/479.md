...
- Every failure on that path now warns. A thread the engine could not splice
  used to be dropped in silence, leaving `duty.log` reading `no resume duty`
  over a board that was not clean (#479).

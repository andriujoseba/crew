...
function buildClaude(t,st){
  ...
  /* ---------- BACK: stacks only, no pack ----------
     The heat-sink plate is GONE. It was recoloured, tapered, finned and
     shadowed across two loops, and from the front it still read as a grey
     wing filling the gap between torso and arm — because from the front,
     that gap IS the drawing. Daylight between the arms and the waist is
     what makes the chest read broad and the unit read fit; the exhaust
     stacks emerge from behind the pauldrons, which is all the mounting a
     front view can honestly show. */

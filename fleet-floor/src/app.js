...
function buildCodex(t,st){
  ...
  [0.86,0.72].forEach(function(sc2){
  ...
  poly(g,[[hxx-28,hy2-10],[hxx-2,hy2-6],[hxx+2,hy2-6],[hxx+28,hy2-10],[hxx+26,hy2-6.5],[hxx,hy2-2.5],[hxx-26,hy2-6.5]]);g.fill();
  var primary=[[hxx-12,hy2+1,4.6],[hxx+12,hy2+1,4.6]];
  /* Loop 21, on the face: a sentinel is a lens CLUSTER, not a pair. Two
     more tertiary lenses at the socket's outer corners take the count to
     eight — small and dim, but at cell size the extra points of light are
     what read as swarm-machine rather than mascot. */
  var minor=[[hxx-21,hy2-6,1.7],[hxx+21,hy2-6,1.7],[hxx-6,hy2+9,1.5],[hxx+6,hy2+9,1.5],[hxx-24,hy2+4,1.2],[hxx+24,hy2+4,1.2]];
  ...
  (function(){var px2=ax+aw*0.42,py2=ay-ah*0.02;
    ...
    g.fillStyle=sc2;g.beginPath();g.arc(px2,py2,15,0,7);g.fill();

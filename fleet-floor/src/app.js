...
function buildKimi(t,st){
  ...
  [-1,1].forEach(function(sg){plate(g,[[cx+sg*44,hy-22],[cx+sg*52,hy-20],[cx+sg*52,hy-8],[cx+sg*44,hy-8]],sM,sB,ed);
    if(!offl){RE.fillStyle=pk(0.5);RE.beginPath();RE.arc(cx+sg*48,hy-14,1.6,0,7);RE.fill();}});

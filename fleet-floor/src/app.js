...
function buildKimi(t,st){
  ...
  /* Chest centre. Powered it hangs with the gauntlets just clearing the
     near-plane worktop line (~local 332); offline the torch dies and it drops
     140px so the knuckles land exactly on the deck — the offline posture IS
     this number. */
  var BY=offl?340:200+bob;

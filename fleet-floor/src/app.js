...
function updateCurrent(){if(VIEW!=="room"||STATE!=="working")return;var d=dataOf(BOX,ROOM);if(!d.cur)return;var el=document.getElementById("cur-el");if(el)el.textContent=fmtDur(Math.floor(Date.now()/1000)-d.cur.start);}

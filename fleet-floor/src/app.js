...
function camStill(t,u,pw,ph){
  ...
  c.drawImage(robo,sx,sy,sw,sh,0,0,pw,ph);
  c.filter="none";
  c.globalCompositeOperation="lighter";
  c.globalAlpha=off?0.4:0.9;c.drawImage(rrim,sx,sy,sw,sh,0,0,pw,ph);
  ...
  c.globalAlpha=0.55;c.filter="blur("+bl+"px)";c.drawImage(remit,sx,sy,sw,sh,0,0,pw,ph);
  c.globalAlpha=0.45;c.filter="blur("+bl*3+"px)";c.drawImage(remit,sx,sy,sw,sh,0,0,pw,ph);
  c.globalAlpha=off?0.5:0.9;c.filter="none";c.drawImage(remit,sx,sy,sw,sh,0,0,pw,ph);

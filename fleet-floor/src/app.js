...
function buildKimi(t,st){
  ...
  [-1,1].forEach(function(sg){
    var shx=cx+sg*108,shy=BY-30, elx=cx+sg*134,ely=BY+30, gxx=cx+sg*128,gyy=BY+96;
    ...
    // Dead, the pressure is gone and the line hangs slack.
    hose(g,shx-sg*9,shy+2,gxx-sg*18,gyy-22,offl?31:22,5.2);
  });

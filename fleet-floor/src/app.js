...
function buildKimi(t,st){
  ...
  var sT="#2e3850",sM="#161d2b",sB="#090d15",ed="#35405a",eH="#4a5872",rc="#05080e";
  if(offl){sT="#1d2330";sM="#0e121b";sB="#06090f";ed="#232a38";eH="#2c3444";}
  ...
  if(!offl){
    var fire=g.createRadialGradient(rc2.x,rc2.y+2,1,rc2.x,rc2.y+2,16);
    fire.addColorStop(0,"rgba(255,240,250,"+(0.9*pulse+0.1)+")");
    fire.addColorStop(0.45,pkh(0.65*pulse+0.1));fire.addColorStop(1,pk(0.14));
    ...
    // the furnace lights the chest it is set into
    g.save();g.globalCompositeOperation="lighter";
    var ch=g.createRadialGradient(rc2.x,rc2.y,8,rc2.x,rc2.y,72);
    ch.addColorStop(0,pk(0.16));ch.addColorStop(0.5,pk(0.06));ch.addColorStop(1,pk(0));
    g.fillStyle=ch;g.beginPath();g.arc(rc2.x,rc2.y,72,0,7);g.fill();g.restore();
  }else{

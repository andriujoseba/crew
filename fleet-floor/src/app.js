...
function buildGrok(t,st){
  ...
  function leg(sgn){
    ...
    var ax=cx+sgn*(offl?31:26), ay=514+d*0.2;
    var fx=cx+sgn*34, fy=546;
  ...
  (function(){var fc="rgba(150,196,235,"+(offl?0.05:0.14)+")";
    ...
    var hy0=362+d*0.55+breath*0.3, kx=cx+(offl?44:38), ky=447+d*0.5,
        ax=cx+(offl?31:26), ay=514+d*0.2, fx=cx+34;
    pl(RR,hcx+20,hby+30,hcx+22,hby+38,fc,1.1);         // cheek ridge, upper flare only
    RR.strokeStyle=fc;RR.lineWidth=1.1;RR.beginPath(); // outermost rear cable, crown reach only
    RR.moveTo(hcx+17,hby+10);
    RR.quadraticCurveTo(hcx+28,hby+21,hcx+36,hby+38);
    RR.stroke();
  ...
  return {hand:hh,coreY:275+breath,hy:hby+8,offl:offl,work:work,
          ...
          feet:[{x:cx-30,y:560,w:24,toes:[cx-43,cx-34,cx-25]},
                {x:cx+30,y:560,w:24,toes:[cx+25,cx+34,cx+43]}]};
}

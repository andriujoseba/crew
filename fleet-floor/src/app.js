...
function buildGrok(t,st){
  ...
  REARC.forEach(function(cb,ci){var s=cb[0], ax=hcx+s*cb[1], ay=hby+8, rank=ci%3;
    ...
    g.strokeStyle=offl?"#20242c":"#343c48";g.lineWidth=1.2;g.beginPath();g.moveTo(ax,ay-1);g.quadraticCurveTo(mx,my-2,tx-s,ty-1);g.stroke();
  ...
  if(!offl){RB.save();RB.globalCompositeOperation="lighter";
    ...
    bounce.addColorStop(0,pu(0.26*pulse));bounce.addColorStop(0.5,pu(0.09*pulse));bounce.addColorStop(1,pu(0));
  ...
  // skull
  plate(g,[[hcx-22,hby+24],[hcx-19,hby+8],[hcx-9,hby],[hcx+9,hby],[hcx+19,hby+8],[hcx+22,hby+24],[hcx+17,hby+46],[hcx+10,hby+56],[hcx-10,hby+56],[hcx-17,hby+46]],sT,sM,ed);
  ...
  plate(g,[[hcx-18,hby+26],[hcx,hby+30],[hcx+18,hby+26],[hcx+14,hby+15],[hcx-14,hby+15]],"#2e3a4c","#1a2331",ed);
  ...
  // was re-seated after
  plate(g,[[hcx-13,hby+44],[hcx+13,hby+44],[hcx+15,hby+58],[hcx+9,hby+66],[hcx-9,hby+66],[hcx-15,hby+58]],sT,sM,ed);
  ...
  (function(){var fc="rgba(150,196,235,"+(offl?0.09:0.24)+")";
    ...
    if(rHang){
      pl(RR,sx+11,sy+15,ex+6,ey-11,fc,1.4);
      pl(RR,ex+5,ey+8,ex-1,wy-37,fc,1.4);
      pl(RR,wx+11.5,wy-33,wx+16.5,wy-23,fc,1.2);
      pl(RR,wx+10,wy+3,wx+8.7,wy+11,fc,1.2);
      pl(RR,wx+9,wy+12,wx+9.4+(offl?2:0),wy+(offl?22:24),fc,1.1);
    } else pl(RR,cx+33,hy0+8,kx+9,ky-9,fc,1.6);
    pl(RR,kx+12,ky-8,kx+15.5,ky+3,fc,1.6);
    pl(RR,kx+6,ky+14,ax+5,ay-6,fc,1.6);
    pl(RR,ax+5,ay+2,fx+7,544,fc,1.4);
    pl(RR,fx+14,547,fx+15,553,fc,1.2);})();

...
function buildKimi(t,st){
  ...
  [-1,1].forEach(function(sg){
    ...
    seg2(g,elx,ely+2,gxx,gyy-30,14,17,sM,sB,ed);
    var gw=52,gh=62;
    ...
    for(var fg=1;fg<4;fg++){pl(g,gxx-gw/2+fg*(gw/4),gyy+gh-30,gxx-gw/2+fg*(gw/4)-1,gyy+gh-33,"rgba(3,6,11,0.5)",1.4);}
    for(var ks=0;ks<4;ks++){bolt(g,gxx-gw/2+8+ks*((gw-16)/3),gyy+gh-33,2.6,offl?0.06:0.24);}

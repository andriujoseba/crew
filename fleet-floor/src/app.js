...
function buildKimi(t,st){
  ...
  /* Status strip along the top of the casing. Kimi is the only unit with no
     hard readout anywhere — claude has a core, codex a reactor, grok a spine
     slit — so its state lived entirely in a face, which is expressive and

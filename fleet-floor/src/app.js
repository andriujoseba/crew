...
function buildGrok(t,st){
  ...
  /* the face scar: one gouge across the brow, aimed at the right optic and
     stopped by it — dark trench, bright torn lip, and the paint never came
     back. A mask that has been hit face-on and kept looking. */
  pl(g,hcx+3,hby+14,hcx+13,hby+25,"rgba(4,8,14,0.65)",2);
  pl(g,hcx+3.5,hby+13,hcx+13.5,hby+24,"rgba(170,192,222,"+(offl?0.14:0.36)+")",0.9);

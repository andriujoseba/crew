...
function buildGrok(t,st){
  ...
  function leg(sgn){
    ...
    limbSeg(g,hx,hy0,kx,ky,15,10,lT,lM);
    ...
    limbSeg(g,kx,ky,ax,ay,9.5,5.4,lT,lM);
    ...
    limbSeg(g,ax,ay,fx,fy,5.5,7.5,lM,lB);
    joint(ax,ay,5);
    ...
    [-1,0,1].forEach(function(ti){var tx2=fx+ti*9;
      ...
      g.fillStyle="rgba(150,168,192,"+(offl?0.06:0.12)+")";g.fillRect(tx2-2,557.4,4,2.6);});
  }
  leg(-1);leg(1);
  stanceOn();
  ...
  plate(g,[[cx-27,348+d*0.6+breath*0.5],[cx+27,348+d*0.6+breath*0.5],[cx+20,380+d*0.55],[cx-20,380+d*0.55]],sT,sM,ed);
  g.fillStyle="rgba(168,192,226,"+(offl?0.06:0.16)+")";
  poly(g,[[cx-27,348+d*0.6+breath*0.5],[cx+27,348+d*0.6+breath*0.5],[cx+24,353+d*0.6],[cx-24,353+d*0.6]]);g.fill();
  // tassets: one angled plate per hip, thrown over the quad
  [-1,1].forEach(function(s){
    plate(g,[[cx+s*20,350+d*0.6],[cx+s*33,353+d*0.58],[cx+s*29,374+d*0.56],[cx+s*18,370+d*0.56]],sM,sB,ed);
  ...
  var handR;
  function arm(sgn,mode){
    var sx=cx+sgn*44, sy=248+breath;
    joint(sx,sy+7,9.5);
    ...
    limbSeg(g,sx+sgn*3,sy+11,ex+sgn*1,ey-5,8,6,sT,sM);
    ...
    function claw(x,y,open){
      ...
      plate(g,[[x+ti*7,y+3],[x+ti*14.5,y+9+tdy],[x+ti*11,y+16+tdy],[x+ti*5.5,y+8]],sT,sB,null);
      ...
      plate(g,[[x-10,y],[x+10,y],[x+8.5,y+9],[x-8.5,y+9]],sM,sB,ed);
      plate(g,[[x-10,y],[x+10,y],[x+8,y+3.6],[x-8,y+3.6]],
      ...
      [-1,0,1].forEach(function(f){
        var sp=f*(open?4.6:1.7), rx=x+f*6;
        var mx3=rx+sp*0.6, my3=y+8+(open?9:11);        // mid knuckle
        ...
        plate(g,[[rx-3.2,y+8],[rx+3.2,y+8],[mx3+2.4,my3],[mx3-2.4,my3]],
        ...
        plate(g,[[mx3-2.2,my3],[mx3+2.2,my3],[tx3+0.9,ty3],[tx3-0.9,ty3]],sM,sB,null);
    ...
    if(mode==='reachdown'){ /* builder: the FLEX — elbow thrown out past the
      ...
      limbSeg(g,ex,ey,hx3,hy3-8,6.5,9.5,sT,sM);
      ...
      limbSeg(g,ex,ey,fx3,fy3+6,6,8.5,sT,sM);
      ...
      var wx=sx-sgn*8, wy=382+d*0.5;
      limbSeg(g,ex,ey,wx,wy,6,8.5,sT,sM);
      // bracer fin off the outer flare, riding the forearm's line
      plate(g,[[wx+sgn*11,wy-34],[wx+sgn*17,wy-22],[wx+sgn*10,wy-14]],sM,sB,ed);

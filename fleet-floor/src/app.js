...
function floorHeaderLabels(){
  ...
  return [
    {text:"FLEET FLOOR",x:26,y:36,font:"700 15px ui-monospace,monospace",color:"#c7d4e4"},
    {text:"heavy-duty/crew · fleet call",x:132,y:36,font:"11px ui-monospace,monospace",color:"#5fd6ff"},
    {text:version,x:26,y:54,font:"10px ui-monospace,monospace",color:"#7f93aa"},
    {text:"scroll · click a unit to zoom in",after:version,x:26,y:54,font:"10px ui-monospace,monospace",color:"#46566a"}
  ];
}
...
function drawFloorHeader(t){
  ...
  floorHeaderLabels().forEach(function(h){
    X.font=h.font;X.fillStyle=h.color;
    var x=h.x;
    if(h.after)x+=X.measureText(h.after).width+18;
    X.fillText(h.text,x,h.y);
  });
  var stat=stageCounts();

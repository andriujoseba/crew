...
function miniStill(t,dW,dH){
  ...
  var sized=e&&e.cv.width===pw&&e.cv.height===ph;
  if(sized&&(t-e.at)<ttl*e.jit)return e;
  if(miniFills>=MINI_BUDGET)return sized?e:null;
  miniFills++;
  if(!e)e=miniStills[key]={cv:oc(pw,ph),at:0,jit:0.7+0.6*(strPhase(key)/6.283),anchors:null};

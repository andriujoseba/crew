...
t vitals-disk-conf-defers-to-table 'VITALS_DISK_LOW_PCT=""' \
  "$(grep '^VITALS_DISK_LOW_PCT=' "$SHARED/conf/fleet.defaults.conf")"
t vitals-memory-conf-defers-to-table 'VITALS_MEMORY_LOW_PCT=""' \
  "$(grep '^VITALS_MEMORY_LOW_PCT=' "$SHARED/conf/fleet.defaults.conf")"
